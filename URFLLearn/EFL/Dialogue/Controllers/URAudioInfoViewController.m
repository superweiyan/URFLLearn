...
//    [self.prevBtn setTitle:@"上一篇" forState:UIControlStateNormal];
    [self.prevBtn setImage:[UIImage imageNamed:@"player_8"] forState:UIControlStateNormal];
...
//    self.nextBtn.titleLabel.font = [UIFont systemFontOfSize:12];
    [self.nextBtn setImage:[UIImage imageNamed:@"player_3"] forState:UIControlStateNormal];
